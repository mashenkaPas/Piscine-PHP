        ...
        <div class ="content-menu">
          ...
          <div class="content-items" >
            <div class="content-row">
              <div class="swim">
                <p>Cost: $8</p>
                  <img class="category-img" src="./assets/t_shirt_1.jpeg" >
                  <form action="./shop_cart.php" method="post">
                    Quantity:
                    <input type="number" name="count_t_shirt_1"  min="1" max="100">
                    <button type="submit" name="buy" value="ok" onclick="alert('Item(s) added to the cart')">Add to Cart</button>
                  </form>
              </div>
              <div class="dresses">
                <p>Cost: $5</p>
                  <img class="category-img" src="./assets/t_shirt_2.jpeg">
                  <form action="./shop_cart.php" method="post">
                    Quantity:
                    <input type="number" name="count_t_shirt_2"  min="1" max="100">
                    <button type="submit" name="buy" value="ok" onclick="alert('Item(s) added to the cart')">Add to Cart</button>
                  </form>
              </div>
            </div>
            <div class="content-row">
              <div class="t-shirts">
                <p>Cost: $7</p>
                  <img class="category-img" src="./assets/t_shirt_3.jpeg">
                  <form action="./shop_cart.php" method="post">
                    Quantity:
                    <input type="number" name="count_t_shirt_3"  min="1" max="100">
                    <button type="submit" name="buy" value="ok" onclick="alert('Item(s) added to the cart')">Add to Cart</button>
                  </form>
              </div>
              <div class="coats">
                <p>Cost: $10</p>
                  <img class="category-img" src="./assets/t_shirt_4.jpeg">
                  <form action="./shop_cart.php" method="post">
                    Quantity:
                    <input type="number" name="count_t_shirt_4"  min="1" max="100">
                    <button type="submit" name="buy" value="ok" onclick="alert('Item(s) added to the cart')">Add to Cart</button>
                  </form>
              </div>
            </div>
